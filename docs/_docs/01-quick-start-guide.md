...
[comment]: <> (title: "Quick-Start Guide")

[comment]: <> (permalink: /docs/quick-start-guide/)

[comment]: <> (excerpt: "How to quickly install and setup Minimal Mistakes for use with GitHub Pages.")

[comment]: <> (last_modified_at: 2020-07-27)
